...
class GoT extends Component {
  ...
  render() {
    ...
    let peoplesPicks = {
        ...
        correct: ['x','x','x','x','x','x','x','dead','x','dead','x','x','dead','dead','dead','dead','dead','x','x','x','x','dead','x','x','x','dead','x','x','x','dead','dead','x','x','No','The Hound','x','No','x','Herself','Lyanna Mormont','x','Arya','x'],
        ...
        ders : ['alive','alive','dead','dead','dead','dead','alive','alive','dead','dead','alive','alive','dead','alive','alive','dead','dead','dead','alive','alive','dead','dead','dead','alive','dead','alive','alive','alive','dead','dead','alive','dead','Throne is Vacant','Yes','The Hound','Yes','Yes','Arya','Euron Greyjoy','Yara Greyjoy','Daenarys Targaryean','Jon Snow','Daenarys Targaryean'],
        doub : ['alive','dead','alive','dead','dead','dead','alive','dead','alive','dead','alive','alive','dead','dead','dead','alive','dead','dead','dead','dead','alive','dead','dead','alive','dead','dead','dead','dead','alive','dead','dead','alive','Throne Destroyed','No','The Hound','Yes','No','Jaime','Arya','Beric Dondarrion','Daenarys Targaryean','Jon Snow','Daenarys Targaryean'],
        nico : ["alive","alive","alive","alive","dead","dead","alive","dead","dead","dead","alive","alive","alive","dead","dead","dead","dead","alive","dead","dead","dead","alive","alive","alive","dead","dead","dead","alive","alive","dead","dead","dead","Throne Destroyed","No","The Hound","Yes","Yes","Jaime","Arya","Beric Dondarrion","Danaerys Targaryean","Jon Snow","Danaerys Targaryean & Jon Snow Together"],
        ...
        davidDeg : ['dead','dead','alive','dead','alive','alive','alive','dead','dead','dead','dead','dead','dead','dead','dead','dead','dead','alive','alive','alive','dead','dead','dead','alive','dead','dead','dead','dead','alive','alive','alive','dead','Throne Destroyed','No','The Hound','No','Yes','Jaime','Jon Snow','Theon','Jaime','Jaime','Daenarys Targaryean'],
        kellyn : ["alive","dead","dead","dead","dead","dead","alive","dead","alive","alive","alive","alive","dead","dead","dead","alive","dead","dead","dead","dead","alive","alive","dead","alive","dead","dead","dead","dead","dead","dead","dead","dead","Throne Destroyed","No","The Hound","Yes","Yes","Jaime","Davos Seaworth","Tormund","Jon Snow","Sam Tarley","Daenarys Targaryean"],
