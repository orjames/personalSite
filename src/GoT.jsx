...
class GoT extends Component {
  ...
  render() {
    ...
    let peoplesPicks = {
        ...
        correct: ["alive", "alive", "alive", "dead", "dead", "dead", "alive", "dead", "alive", "dead", "alive", "alive", "dead", "dead", "alive", "dead", "dead", "alive", "alive", "alive", "alive", "dead", "alive", "alive", "alive", "dead", "alive", "alive", "alive", "dead", "dead", "alive", "Throne Destroyed", "No", "Tie", "No", "No", "Drogon / Rubble", "Herself", "Lyanna Mormont", "Daenarys Targaryen ", "Arya", "N/A (bran?)"],
