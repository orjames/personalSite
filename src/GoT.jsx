...
class GoT extends Component {
  ...
  render() {
    ...
    let peoplesPicks = {
        ...
        correct: ["alive", "alive", "alive", "dead", "dead", "dead", "alive", "dead", "alive", "dead", "alive", "alive", "dead", "dead", "alive", "dead", "dead", "alive", "alive", "alive", "alive", "dead", "N/A", "alive", "alive", "dead", "alive", "alive", "alive", "dead", "dead", "N/A", "Throne Destroyed", "No", "Tie", "No", "No", "Drogon / Rubble", "Herself", "Lyanna Mormont", "Daenarys Targaryen", "Arya", "N/A (bran?)"],
        owen : ['alive','alive','alive','dead','dead','alive','alive','dead','alive','dead','alive','alive','alive','dead','dead','alive','dead','alive','alive','alive','alive','dead','dead','alive','dead','alive','alive','alive','alive','alive','dead','dead','Throne Destroyed','No','The Hound','Yes','Yes','Jaime','Night King','Beric Dondarrion','Cersei','Jon Snow','Jon Snow'],
